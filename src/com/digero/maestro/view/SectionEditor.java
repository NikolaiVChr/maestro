...
//				}
			...
			private void addScrollToTabs() {
				miscPanelM.add(tabMiscScroll, "0, 1, 7, 1, f, f");
				doublingPanelM.add(tabDoubleScroll, "0, 1, 7, 1, f, f");
				rangePanelM.add(tabRangeScroll, "0, 1, 7, 1, f, f");
			}
